...
const SEED_IDEAS = [
  { title: "Collab OS vNext", description: "Merge Command Center insights with Rose Brain memory for proactive nudges.", submittedBy: "Rose Almeida", status: "needs-rose-review" as const, momentum: 92, cluster: "Platform", benefits: ["Proactive leadership signals", "Less manual review"], risks: ["Scope creep"], dependencies: ["Command Center Build"], approvalRoute: "both" as const, createdAt: "2026-06-12" },
