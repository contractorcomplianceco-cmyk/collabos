  ...
  const decisionGroups: { id: string; title: string; cards: DecisionCard[] }[] = [
    {
      ...
      cards: [
        ...
        },
        {
          id: "dec-risk-audit",
          title: "Risk Audit",
          detail: "Audit Risk Model is live at audit.cagteam.net with API online, but still needs leadership sign-off before it is treated as an approved product path.",
          status: "Needs your decision",
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          detail: "CAG parent (complianceauthoritygroup.com), CCA corporate (contractor-compliance-authority.com), and contractor landing (ccacontractor.com) are live. Confirm production URLs and launch readiness are final.",
          status: "Needs your confirmation",
          href: "/projects",
        },
        {
          id: "dec-investor",
          title: "Investor Boardrooms",
          detail: "CCA room live at investor.ccacontact.com (~75%). CAG dual boardroom live at caginvestor.ccacontact.com (~85%). Confirm each experience is ready vs still in progress.",
          status: "Needs your confirmation",
        ...
        },
        {
          ...
          detail: "Intake is live at intake.ccacontact.com (discovery.ccacontact.com redirects to the public site). Confirm whether Discovery stays on Supabase until Core is approved, and what the long-term live path is.",
          status: "Needs your confirmation",
          href: "https://intake.ccacontact.com/",
          external: true,
        },
        {
          id: "dec-experience",
          title: "CCA Client Experience",
          detail: "Live at experience.ccacontact.com. Confirm whether this is the finished client-facing experience or still evolving.",
          status: "Needs your confirmation",
          href: "https://experience.ccacontact.com/",
          external: true,
        },
      ],
    },
